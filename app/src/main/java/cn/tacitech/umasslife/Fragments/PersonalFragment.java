...
public class PersonalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Header bgName
        TextView personal_header_bgName = view.findViewById(R.id.personal_header_bgName);
        personal_header_bgName.setText(getStudentName()); // 传入用户姓名
        personal_header_bgName.setTypeface(UiModule.getTypeface(getActivity(), UiModule.DIN)); // 设置字体
